                ...
                <div class="widget-content widget-content-area br-6">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="custom-heading-wrapper">
                            <h1 class="m-0 p-0 custom-heading">Edit Chapter</h1>
                        ...
                        <div>
                            <a class="btn btn-primary" href="{{ route($url_group.'.chapter.edit', $data->id) }}">
                    ...
                    <div class="mt-5 from-wrapper">
                        <form action="{{ route($url_group.'.chapter.update', $data->id) }}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <img id="chapter-icon" src="{{ $data->icon ? asset('storage/'.$data->icon) : asset('no-image.png') }}" alt="" srcset="" class="input-group-text m-0 p-0" id="basic-addon5" width="100px" height="45px">
                                            </div>
                                            <input type="hidden" name="old_icon" value="{{ $data->icon }}" id="">
